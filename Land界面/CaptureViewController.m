...
- (void)viewDidLoad
{
    ...
    //保存按钮
    UIBarButtonItem *doneItem = [[UIBarButtonItem alloc] initWithTitle:@"上传" style:UIBarButtonItemStylePlain target:self action:@selector(saveButton)];
...
-(void)saveButton
{
    ...
    //[self dismissModalViewControllerAnimated:YES]; ios6 弃用
